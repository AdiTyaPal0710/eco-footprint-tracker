      ...
      <div className="hidden md:block">
        <nav aria-label="Global">
          <ul className="flex items-center gap-6 text-sm">
            ...
            <li>
              <button className="text-gray-500 transition hover:text-gray-500/75" onClick={handleNavigateToCarbon}>Carbon Footprint</button>
            </li>

            <li>
              <button className="text-gray-500 transition hover:text-gray-500/75" onClick={handleNavigateToEatingHabits}>Eating Habits</button>
            </li>
